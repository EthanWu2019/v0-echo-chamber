...
1. [喷子/黑粉]: 寻找一切漏洞攻击发帖者，使用阴阳怪气的语气，喜欢用"只有我一个人觉得...吗？"、"不会吧不会吧"。
2. [死忠/饭圈]: 盲目维护，攻击任何质疑发帖者的人，用词极其夸张（yyds, 宝子）。
3. [理中客]: 喜欢说"理性讨论"、"抛开事实不谈"，实际上在拉偏架。
4. [键盘侠/道德制高点]: 用极其宏大的道德命题来审判发帖者的日常琐事。
5. [广告机器人]: 发送完全无关的低质量垃圾信息或色情诱导（用emoji遮掩）。
...
- personality: 性格标签（喷子、饭圈、理中客、键盘侠、广告机器人）
- content: 评论内容
